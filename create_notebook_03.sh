...
# "03-Outbreak-Investigation-Dashboard.ipynb"
# ==============================================================================
...
OUTPUT_FILE="${NOTEBOOK_DIR}/03-Outbreak-Investigation-Dashboard.ipynb"

echo "--- Creating Outbreak Investigation Dashboard Notebook: '$OUTPUT_FILE' ---"
