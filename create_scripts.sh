...
# ==============================================================================
# Script to Generate the Standalone Python Script Files in a nested directory
...
# ./digital-epidemic-surveillance-platform/scripts
# ==============================================================================

# Exit immediately if a command exits with a non-zero status.
set -e

# Define the specific, nested path to the scripts directory.
# This assumes you are running the script from the top-level project folder.
NESTED_SCRIPTS_DIR="digital-epidemic-surveillance-platform/scripts"

echo "--- Populating the nested scripts directory: './$NESTED_SCRIPTS_DIR' ---"

# Check if the target directory exists. If not, create it.
# The -p flag ensures all parent directories are created as needed.
mkdir -p "$NESTED_SCRIPTS_DIR"

# --- Define the file to be created and its full path ---
SCRIPT_FILE_NAME="qgis_risk_assessment.py"
OUTPUT_FILE="${NESTED_SCRIPTS_DIR}/${SCRIPT_FILE_NAME}"

# --- Write the content of the Python script to the file ---
...
echo ""
echo "✅ Script file(s) have been created successfully in the nested 'scripts/' directory."